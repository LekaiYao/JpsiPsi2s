...
void Fit_4D_tot() {
    ...
    // Signal p.d.f.
    RooRealVar Jpsi_mean("Jpsi_mean", "Jpsi_mean", 3.0969, 3.05, 3.15);    // PDG
    RooRealVar Jpsi_devia1("Jpsi_devia1", "Jpsi_devia1", 0.0208, 0, 0.03);
    RooRealVar Jpsi_alpha1("Jpsi_alpha1", "Jpsi_alpha1", 0.903, 0.1, 5);
    RooRealVar Jpsi_nx1("Jpsi_nx1", "Jpsi_nx1", 15.0, 0, 50);
    RooRealVar Jpsi_devia2("Jpsi_devia2", "Jpsi_devia2", 0.0521, 0.02, 0.08);
    RooRealVar Jpsi_ratio("Jpsi_ratio", "Jpsi_ratio", 0.784, 0, 1);
    ...
    // Signal p.d.f.
    RooRealVar psi2S_mean("psi2S_mean", "psi2S_mean", 3.686, 3.63, 3.73);    // PDG
    RooRealVar psi2S_devia1("psi2S_devia1", "psi2S_devia1", 0.0388, 0.01, 0.05);
    RooGaussian psi2SMassSig("psi2SMassSig", "psi2SMassSig", psi2S_mass, psi2S_mean, psi2S_devia1);
    // Background p.d.f.
    RooRealVar psi2S_a("psi2S_a", "psi2S_a", -0.376, -1, 0.1);
    RooRealVar psi2S_b("psi2S_b", "psi2S_b", 0.0865, -0.5, 0.5);
    RooChebychev psi2SMassComb("psi2SMassComb", "psi2SMassComb", psi2S_mass, RooArgList(psi2S_a, psi2S_b));
    
    // Define J/psi Ctau p.d.f.
    // Signal p.d.f.
    RooRealVar Jpsi_mu1("Jpsi_mu1", "Jpsi_mu1", -0.000174, -0.005, 0.005);
    RooRealVar Jpsi_sigma1("Jpsi_sigma1", "Jpsi_sigma1", 0.000636, 0, 0.003);
    RooRealVar Jpsi_sigma2("Jpsi_sigma2", "Jpsi_sigma2", 0.00286, 0.002, 0.008);
    ...
    RooRealVar Jpsi_prop1("Jpsi_prop1", "Jpsi_prop1", 0.174, 0, 1);
    RooAddPdf JpsiCtauSig("JpsiCtauSig", "JpsiCtauSig", RooArgList(Jpsi_gauss1, Jpsi_gauss2), Jpsi_prop1);
    // Background p.d.f.
    RooRealVar Jpsi_sigma3("Jpsi_sigma3", "Jpsi_sigma3", 0.00135, 0, 0.01);
    RooRealVar Jpsi_coef1("Jpsi_coef1", "Jpsi_coef1", 0.0277, 0.01, 0.1);
    ...
    RooRealVar Jpsi_prop2("Jpsi_prop2", "Jpsi_prop2", 0.264, 0, 1);
    ...
    RooRealVar Jpsi_mu3("Jpsi_mu3", "Jpsi_mu3", -0.000474, -0.005, 0.005);
    RooRealVar Jpsi_sigma6("Jpsi_sigma6", "Jpsi_sigma6", 0.00565, 0.001, 0.01);
    RooRealVar Jpsi_sigma7("Jpsi_sigma7", "Jpsi_sigma7", 0.00312, 0.001, 0.02);
    RooRealVar Jpsi_coef3("Jpsi_coef3", "Jpsi_coef3", 0.0785, 0.01, 0.2);
    RooRealVar Jpsi_prop3("Jpsi_prop3", "Jpsi_prop3", 0.767, 0, 1);
    ...
    // Signal p.d.f.
    RooRealVar psi2S_mu1("psi2S_mu1", "psi2S_mu1", -0.000119, -5e-4, 5e-4);
    RooRealVar psi2S_sigma2("psi2S_sigma2", "psi2S_sigma2", 0.00204, 0.001, 0.012);
    RooRealVar psi2S_alpha2("psi2S_alpha2", "psi2S_alpha2", -4.93, -5, 0, "");
    RooRealVar psi2S_nx2("psi2S_nx2", "psi2S_nx2", 2.82, 0, 5);
    RooCBShape psi2SCtauSig("psi2SCtauSig", "psi2SCtauSig", psi2S_ctau, psi2S_mu1, psi2S_sigma2, psi2S_alpha2, psi2S_nx2);
    // Background p.d.f.
    RooRealVar psi2S_sigma3("psi2S_sigma3", "psi2S_sigma3", 0.000565, 0, 0.02);
    RooRealVar psi2S_coef1("psi2S_coef1", "psi2S_coef1", 0.0309, 0.01, 0.1);
    RooGExpModel psi2SCtauBkg("psi2SCtauBkg", "psi2SCtauBkg", psi2S_ctau, psi2S_sigma3, psi2S_coef1, false, RooGExpModel::Type::Flipped);
    // Combinatorial signal p.d.f.
    RooRealVar psi2S_prop2("psi2S_prop2", "psi2S_prop2", 1.00, 0, 1);
    RooAddPdf psi2SCtauCombSig("psi2SCtauCombSig", "psi2SCtauCombSig", RooArgList(psi2SCtauSig, psi2SCtauBkg), psi2S_prop2);
    // Combinatorial background p.d.f.
    RooRealVar psi2S_mu3("psi2S_mu3", "psi2S_mu3", -0.000090, -0.001, 0.001);
    RooRealVar psi2S_alpha3("psi2S_alpha3", "psi2S_alpha3", 1.14, 0.1, 10);
    RooRealVar psi2S_nx3("psi2S_nx3", "psi2S_nx3", 2.08, 0.5, 20);
    RooRealVar psi2S_sigma6("psi2S_sigma6", "psi2S_sigma6", 0.00309, 0, 0.007);
    RooRealVar psi2S_sigma7("psi2S_sigma7", "psi2S_sigma7", 0.00179, 0, 0.02);
    RooRealVar psi2S_coef3("psi2S_coef3", "psi2S_coef3", 0.0254, 0.01, 0.1);
    RooRealVar psi2S_prop3("psi2S_prop3", "psi2S_prop3", 0.454, 0, 1);
    ...
    RooRealVar n_P_P("n_P_P", "n_P_P", 964, 1e1, N);
    RooRealVar n_P_NP("n_P_NP", "n_P_NP", 118, 1, N);
    RooRealVar n_NP_P("n_NP_P", "n_NP_P", 7.87, 0, N);
    RooRealVar n_NP_NP("n_NP_NP", "n_NP_NP", 1.18e3, 1, N);
    RooRealVar n_Sig_Comb("n_Sig_Comb", "n_Sig_Comb", 4.78e3, 1, N);
    RooRealVar n_Comb_Sig("n_Comb_Sig", "n_Comb_Sig", 92.3, 0, N);
    RooRealVar n_Comb_Comb("n_Comb_Comb", "n_Comb_Comb", 713, 1, N);
