...
void nopre_fit() {
    ...
    // RooRealVar Jpsi_mean("Jpsi_mean", "Jpsi_mean", 3.09267);
    // RooRealVar Jpsi_devia1("Jpsi_devia1", "Jpsi_devia1", 0.0183421);
    // RooRealVar Jpsi_alpha1("Jpsi_alpha1", "Jpsi_alpha1", 4.56109);
    // RooRealVar Jpsi_nx1("Jpsi_nx1", "Jpsi_nx1", 4.7303);
    // RooRealVar Jpsi_devia2("Jpsi_devia2", "Jpsi_devia2", 0.0411148);
    // RooRealVar Jpsi_alpha2("Jpsi_alpha2", "Jpsi_alpha2", 3.40939);
    // RooRealVar Jpsi_nx2("Jpsi_nx2", "Jpsi_nx2", 3.99933);
    // RooRealVar Jpsi_ratio("Jpsi_ratio", "Jpsi_ratio", 0.41768);
    ...
    // RooRealVar psi2S_alpha1("psi2S_alpha1", "psi2S_alpha1", 3, 0.1, 10);
    // RooRealVar psi2S_nx1("psi2S_nx1", "psi2S_nx1", 3, 0.5, 10);
    // RooRealVar psi2S_mean("psi2S_mean", "psi2S_mean", 3.68321);
    // RooRealVar psi2S_devia1("psi2S_devia1", "psi2S_devia1", 0.0347608);
    // RooRealVar psi2S_alpha1("psi2S_alpha1", "psi2S_alpha1", 1.75776);
    // RooRealVar psi2S_nx1("psi2S_nx1", "psi2S_nx1", 1.75922);
    // RooRealVar psi2S_devia2("psi2S_devia2", "psi2S_devia2", 0.0502418);
    // RooRealVar psi2S_alpha2("psi2S_alpha2", "psi2S_alpha2", 1.43151);
    // RooRealVar psi2S_nx2("psi2S_nx2", "psi2S_nx2", 19.9748);
    // RooRealVar psi2S_ratio("psi2S_ratio", "psi2S_ratio", 0.680182);
    ...
    // RooRealVar psi2S_a("psi2S_a", "psi2S_a", -0.446055);
    // RooRealVar psi2S_b("psi2S_b", "psi2S_b", 0.0428658);
    ...
    // RooGaussian JpsiCtauSig("JpsiCtauSig", "JpsiCtauSig", Jpsi_ctau, Jpsi_mu1, Jpsi_sigma1);
    // Background p.d.f.
    ...
    // RooAddPdf JpsiCtauCombSig("JpsiCtauCombSig", "JpsiCtauCombSig", RooArgList(JpsiCtauSig));
    ...
    // RooCBShape Jpsi_gauss4("Jpsi_gauss4", "Jpsi_gauss4", Jpsi_ctau, Jpsi_mu3, Jpsi_sigma6, Jpsi_alpha3, Jpsi_nx3);
    ...
    // RooRealVar psi2S_mu1("psi2S_mu1", "psi2S_mu1", 0, -1e-4, 1e-4);
    // RooRealVar psi2S_sigma1("psi2S_sigma1", "psi2S_sigma1", 0.001, 0, 0.003);
    // RooRealVar psi2S_sigma2("psi2S_sigma2", "psi2S_sigma2", 0.005, 0.003, 0.006);
    ...
    // RooCBShape psi2S_gauss2("psi2S_gauss2", "psi2S_gauss2", psi2S_ctau, psi2S_mu1, psi2S_sigma2, psi2S_alpha2, psi2S_nx2);
    ...
    // RooAddPdf psi2SCtauCombSig("psi2SCtauCombSig", "psi2SCtauCombSig", RooArgList(psi2SCtauSig));
    // Combinatorial background p.d.f.
