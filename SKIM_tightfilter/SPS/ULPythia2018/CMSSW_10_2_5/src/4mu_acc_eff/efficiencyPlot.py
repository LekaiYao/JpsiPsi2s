#!/usr/bin/env python3
"""
SKIM efficiency map: SPS (single event loop, v2 ntuple compatible).
...
Reference: docs/READ.md (2026-07-13), test_v2_efficiency.py in DPS directory.
"""
...
inFileDir = "Ntuple/"
inFileList = ["Ntuple_2018_SPS_{}.root".format(i) for i in range(1, 11)]
